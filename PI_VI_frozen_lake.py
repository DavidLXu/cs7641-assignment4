...
problem = "Frozen Lake {}x{} - ".format(N,N)
...
for gamma in gammas:
    ...
    plt.xlabel("iteration")
    plt.ylabel("Mean Value")
    plt.legend([0.3,0.4,0.5,0.6,0.7,0.8,0.9])
    plt.title(problem+algo_name+"Mean Value Over Iteration")
    plt.savefig(problem+algo_name+"Mean Value Over Iteration")
...
plt.xlabel("iteration")
plt.ylabel("Reward")
plt.savefig(problem + algo_name+"Reward Over Iteration")
...
plt.figure(problem + algo_name+"Error Over Iteration")
plt.title(problem + algo_name+"Error Over Iteration")
plt.plot(iteration,error)
plt.xlabel("iteration")
plt.ylabel("Error")
plt.savefig(problem + algo_name+"Error Over Iteration")
# plt.show()



"""Value Iteration, iteration curve with different gamma"""
